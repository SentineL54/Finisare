                              ...
                              <div class="card-body">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                           <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                 <div class="form-group">
                                                       <label for="exampleInputEmail3" class="Chakra yazi_700" id="formLabel">Kategori İçerik :</label>
                                     ...
                                     <div class="row">
                                          <div class="col-4 hidden-sm hidden-xs justify-content-end aling-self-end aling-items-end offset-xl-8 offset-lg-8 offset-md-8" >
                                                <button type="submit" name="categoryCreate" class="margin-top-30 boyutla btn btn-primary Chakra yazi_500" style="font-size:20px;">
                                                       EKLE
                                                </button>
                                          </div>
