          ...
          <?php
             ...
             if( $data === NULL ):
                  ...
                  self:: headerLocation( 3 , 'slider/read' ); // Page -> Redirection
                   ...
                   <form method="post" class="card" id="grayColor" enctype="multipart/form-data" >
                                    ...
                                    <? endif; ?>
                                           ...
                                           <div class="flex flexRow">
                                                 <div class="flexItem">
                                                       ...
                                                       <textarea readonly class="form-control" name="description" maxlength="165" placeholder="Slider Açıklama :" id="exampleFormControlTextarea1" rows="2"><?=$item['description'];?></textarea>
                                                 </div>
                                           </div>
                                           <div class="flex flexRow">
                                                 <div class="flexItem">
