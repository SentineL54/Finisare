                                                 ...
                                                 <div class="flexItem card">
                                                       ...
                                                       <div class="flex flexRow">
                                                             <div class="flexItem">
                                                                   ...
                                                                   <textarea class="form-control" name="description" maxlength="165" placeholder="Slider Açıklama :" id="exampleFormControlTextarea1" rows="2"><?=$item['description'];?></textarea>
                                                             </div>
                                                       </div>
                                                       <div class="flex flexRow">
                                                             <div class="flexItem">
