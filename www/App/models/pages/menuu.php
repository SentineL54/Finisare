...
class menuu extends Model {
      ...
      public function deleteBring( $data = NULL ){
             ...
             if( $data != NULL ){
                   ...
                   $this -> menuDelete = $this->delete( "DELETE FROM $this->tableName WHERE random=:random" , [ 'random' => $data ] );
                   ...
                   if( $this -> menuDelete AND $this -> subMenuDelete AND $this -> movementSave )
                        return $this->delete;
                   else
                        return FALSE;
